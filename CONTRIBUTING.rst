...
#. use the search functionality `here <https://github.com/NLeSC/dask-cassandra-loader/issues>`__ to see if someone already filed the same issue;
...
#. Install developer requirements with ``pip install -e . -r requirements.txt``;
#. make sure the existing tests still work by running ``python setup.py test``;
#. add your own tests (if necessary);
#. update or expand the documentation;
#. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the dask-cassandra-loader repository on GitHub;
